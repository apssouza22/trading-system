...
import com.apssouza.mytrade.trading.domain.forex.order.StopOrderDto.StopOrderType;
...
import static com.apssouza.mytrade.trading.domain.forex.order.StopOrderDto.StopOrderStatus.CREATED;
import static com.apssouza.mytrade.trading.domain.forex.order.StopOrderDto.StopOrderStatus.FILLED;
...
import static com.apssouza.mytrade.trading.domain.forex.portfolio.Position.ExitReason.STOP_ORDER_FILLED;
import static com.apssouza.mytrade.trading.domain.forex.portfolio.Position.PositionStatus.CLOSED;
import static com.apssouza.mytrade.trading.domain.forex.session.event.EventType.PRICE_CHANGED;
