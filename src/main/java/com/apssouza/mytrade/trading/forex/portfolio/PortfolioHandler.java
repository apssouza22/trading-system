...
import com.apssouza.mytrade.trading.forex.session.FilledOrderProcessor;
...
public class PortfolioHandler {
    ...
    private final FilledOrderProcessor filledOrderProcessor;
    ...
    public PortfolioHandler(
        ...
        this.filledOrderProcessor = new FilledOrderProcessor(portfolio, historyHandler);
    }
...
//            Not process order coming from signal if( exists a exit for the currency
    ...
    private void onFill(FilledOrderDto filledOrder) {
        filledOrderProcessor.onFill(filledOrder);
    }
}
